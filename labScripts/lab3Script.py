...
sensor2 = adafruit_tsl2591.TSL2591(i2c)		# High range lux sensor

# Set MQTT broker and topic
broker = "test.mosquitto.org"	# Broker 

pub_topic = "IoTLab"       # send messages to this topic
...
while True:
	data_to_send = "{}.{}".format(get_lux(), get_proximity())	# Here, call the correct function from the sensor section depending on sensor
